...
dough::World world = dough::World(((float)1/60), -9.81, 100, 4, 8);
...
int main() {
    ...
    world.particles[0].setPosition(dough::Vector3(0,0,0));
    world.particles[1].setPosition(dough::Vector3(0,0,1));
    dough::ParticleSpring* spring0 = new dough::ParticleSpring(&world.particles[0], 5.0f, 1.0f); 
    world.getForceRegistry().add(&world.particles[1], spring0);
    world.particles[2].setPosition(dough::Vector3(0,1,0));
    world.particles[3].setPosition(dough::Vector3(0,1,1));
    world.particles[4].setPosition(dough::Vector3(1,0,0));
    world.particles[5].setPosition(dough::Vector3(1,0,1));
    world.particles[6].setPosition(dough::Vector3(1,1,0));
    world.particles[7].setPosition(dough::Vector3(1,1,1));
    auto i = world.particles.begin();
    for (; i != world.particles.end(); i++) {
        i->setAcceleration(dough::Vector3(0,-9.81,0));
        dough::Vector3 position = i->getPosition();
        i->setPosition(position+dough::Vector3(0,5,0));
    }
